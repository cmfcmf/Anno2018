...
export function islandFromIsland3File(id: number, position: PIXI.Point, isSouth: boolean, numBaseIsland: number,
                                      data: Stream): Island {
...
export function islandFromIsland4File(id: number, position: PIXI.Point, isSouth: boolean, numBaseIsland: number,
                                      data: Stream): Island {
    return islandFromIsland3File(id, position, isSouth, numBaseIsland, data);
}

export function islandFromIsland5File(id: number, position: PIXI.Point, isSouth: boolean, numBaseIsland: number,
                                      data: Stream): Island {
    return islandFromIsland3File(id, position, isSouth, numBaseIsland, data);
}
