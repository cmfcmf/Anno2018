...
if (args.length !== 4) {
    console.error("Please provide the input path to a .wav file as well as the output path to a .mp3 or .wav file.");
    process.exit(1);
}
...
if (!outFilePath.toLowerCase().endsWith(".mp3") && !outFilePath.toLowerCase().endsWith(".wav")) {
